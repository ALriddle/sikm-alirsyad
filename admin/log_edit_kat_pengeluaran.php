<?php 
	...
	$query = "UPDATE kategory_pengeluaran SET	ID_KAT_PENGELUARAN='$ID_KAT_PENGELUARAN', NAMA_PENGELUARAN='$NAMA_PENGELUARAN', KODE_PENGELUARAN='$KODE_PENGELUARAN' 
			  WHERE ID_KAT_PENGELUARAN='$ID_KAT_PENGELUARAN'";
