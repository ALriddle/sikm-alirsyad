<?php include('header.php'); ?>
				...
				<div class="box span6">
					...
					<div class="box-header well">
						<h2><i class="icon-list-alt"></i>Rekapitulasi Pemasukan Kas dan Bank Berdasarkan Kategory</h2>
						<div class="box-icon">
						<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						</div>
					</div>
					...
					<div class="box-header well">
						<h2><i class="icon-list-alt"></i>Rekapitulasi Pengeluaran Kas dan Bank Berdasarkan Kategory</h2>
						<div class="box-icon">
						<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						</div>
					</div>
