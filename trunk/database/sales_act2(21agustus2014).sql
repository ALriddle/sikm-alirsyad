...
--
-- Host: localhost
-- Generation Time: Aug 21, 2014 at 04:05 PM
...
(6, '2014-05-06', 'Luqman', 0, 300000, 'IDT', 'Kajian Bulanan'),
...
(101, 'GJ ', '2014-05-01', 0, 30000000, 0, 0, 'Operasional');
...
CREATE TABLE IF NOT EXISTS `kategory_donatur` (
  `ID_KAT_DONATUR` int(50) NOT NULL,
  `NAMA_DONATUR` varchar(50) NOT NULL,
...
(2, 'Luqman', 4000000, 'IDT', 'KETERANGAN'),
(3, 'Muhammad', 2147483647, 'Donatur Tetap', 'Celengan Jumat');
