...
--
-- Host: localhost
-- Waktu pembuatan: 08. April 2014 jam 15:54
-- Versi Server: 5.1.41
-- Versi PHP: 5.3.1
...
--
-- Struktur dari tabel `activity_status`
--
...
--
-- Dumping data untuk tabel `activity_status`
--
...
--
-- Struktur dari tabel `building_function`
--
...
--
-- Dumping data untuk tabel `building_function`
--
...
--
-- Struktur dari tabel `data_transaksi_kas`
--
...
--
-- Dumping data untuk tabel `data_transaksi_kas`
--
...
--
-- Dumping data untuk tabel `dim_area`
--
...
--
-- Dumping data untuk tabel `dim_tim`
--
...
--
-- Struktur dari tabel `fact_report_customer1`
--
...
CREATE TABLE IF NOT EXISTS `fact_report_customer1` (
  ...
  `EXTENSION_ADDRESS` varchar(100) DEFAULT NULL,
...
--
-- Dumping data untuk tabel `fact_report_customer1`
--
...
(136, '2013-08-20', '3', 'FW7', '3008', 'Blok 1', 'Perumahan Sukolilo Park Regency', '9', '6', 'Perez', '083845545527', '0000-00-00 00:00:00', '1A', '', '', '4A', '', '6A', '', '2013-08-20'),
...
(138, '2013-08-20', '2', 'FN2', '3024', 'Blok 25', 'Perumahan Sukolilo Park Regency', '25', '4 ', 'Perez', '13123123123123', '2013-08-07 03:00:00', '1A', '', '', '4A', '', '6A', '', '2013-08-06'),
(137, '2013-08-20', '2', 'FN2', '3004', 'Blok 1', 'Perumahan Sukolilo Park Regency', '5', '2', 'Perez', '8888888888', '0000-00-00 00:00:00', '1A', '', '', '4A', '', '6A', '', '2013-08-01');

-- --------------------------------------------------------

--
-- Struktur dari tabel `failed_status`
--
...
--
-- Dumping data untuk tabel `failed_status`
--
...
--
-- Struktur dari tabel `history_tim`
--
...
--
-- Dumping data untuk tabel `history_tim`
--
...
--
-- Struktur dari tabel `house_owner_profile`
--
...
--
-- Dumping data untuk tabel `house_owner_profile`
--
...
--
-- Struktur dari tabel `house_owner_status`
--
...
--
-- Dumping data untuk tabel `house_owner_status`
--
...
('3001', 'Morales', 'abc-11111', 'Perumahan Sukolilo Park Regency', 'Blok 1', '2', 'ND-2', '0', 'Surabaya Pusat', 'PS-001', '19233201'),
...
('AB1000', 'Morales', 'mamama', 'Surabaya', 'Surasura', '55', 'ND-3', '2', 'Surabaya Timur', 'PS-153', '07979797979');
