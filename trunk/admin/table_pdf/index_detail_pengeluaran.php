...
$query4 = mysql_query("SELECT * FROM data_transaksi WHERE TANGGAL BETWEEN '$tgl_awal' and '$tgl_akhir' AND NAMA_PENGELUARAN ='$kategori3' ORDER BY TANGGAL") or die(mysql_error());

$query5 = mysql_query("Select Sum(KELUAR) as totaldetail from data_transaksi WHERE TANGGAL between '$tgl_awal' and '$tgl_akhir' AND NAMA_PENGELUARAN='$kategori3'") or die(mysql_error());
...
$pdf->Cell(7,1,$cell[$j][9],'LBTR',0,'C');
