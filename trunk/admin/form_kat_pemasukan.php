<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="form_pegawai.php">Manajemen Kategori Pemasukan </a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					...
					<div class="span4"><a class="btn btn-success" href="../admin/form_register_kat_pemasukan.php"><i class="icon icon-white icon-add"></i> Tambah Kategori Pemasukan</a></div>
					<div align="right">
					...
					<div class="box span12">
					<div class="box-content">
					<form method=POST action=log_view_kat_pemasukan.php>
...
<?php
include"log_view_kat_pemasukan.php";
?>
</table>
</form>            
					</div>
