...
$set= true;
	...
	if($no_transaksi=='' || $nama_donatur=='' || $tanggal_transaksi=='' || $bulan_transaksi=='' || $tahun_transaksi=='' || $jumlah_donasi_l=='' || $kode_donatur=='' || $keterangan=='')
		{
	echo "<script language = 'JavaScript'>alert('Data yang Anda masukkan tidak lengkap');
			document.location='form_register_pemasukan_donatur_langsung.php';
					  </script>"; 
	}else{
