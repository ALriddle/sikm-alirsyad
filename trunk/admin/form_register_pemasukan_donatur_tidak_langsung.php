<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="form_register_pemasukan_donatur_tidak_langsung.php">Input Data Donatur</a>
					</li>
				</ul>
			</div>
					...
					<div class="box-content">
						<form class="form-horizontal" action="log_save_register_pemasukan_donatur_tidak_langsung.php" method="post">
							<fieldset>
							  ...
							  <div class="control-group">
								<label class="control-label" for="JUMLAH_DONASI_TL">JUMLAH DONASI :</label>
								<div class="controls">
								  <input class="input-xlarge focused" name="JUMLAH_DONASI_TL" type="text" value="">
								</div>
							  </div>
							  <div class="control-group">
