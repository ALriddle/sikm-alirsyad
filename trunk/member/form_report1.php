...
echo date("Y/m/d") . "";?>" name="DATE_NOW" readonly="readonly">
							...
							<div class="control-group">
							  <label class="control-label" for="salesid">Sales ID</label>
								<div class="controls">
								  <input type="text" id="NAMA_TEAM" name="NAMA_TEAM" value="<?php echo $qhasilteam;?>" readonly>
							&nbsp;
								<input type="text" id="SALES_ID" name="SALES_ID" value="<?php echo $qhasilsalesid;?>" readonly>
								</div>
								</div>
						...
						<div class="control-group">
							  ...
							  <div class="controls">
											<input type="text"  id="EXTENSION_ADDRESS" name="EXTENSION_ADDRESS" class="input-xlarge" value="">
											<input type="text" value="" id="STREET"  name="STREET">
											<br>
											<br>
											<input type="text" id="HOUSE_NUMBER" value="" name="HOUSE_NUMBER" class="input-mini">
							  </div></div>
