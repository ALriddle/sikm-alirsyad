...
--
-- Host: localhost
-- Generation Time: Nov 22, 2014 at 09:56 PM
...
CREATE TABLE IF NOT EXISTS `data_transaksi_bank` (
  ...
  `MASUK_BANK` bigint(20) NOT NULL,
  `KELUAR_BANK` bigint(20) NOT NULL,
...
(2, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-02', 272000, 0, ' Setoran ke Bank (Infaq Celengan Renovasi) ', '4', '2014'),
(1, '1102', 'BANK', '', '2014-04-02', 5729420, 0, ' Saldo awal ', '4', '2014'),
(3, '1102', 'BANK', '', '2014-04-02', 400000, 0, ' Setoran ke Bank (SPP) ', '4', '2014'),
(4, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-02', 1011000, 0, ' Setoran ke Bank (Infaq Celengan Renovasi) ', '4', '2014'),
(5, '1102', '', 'BANK', '2014-04-02', 0, 7000000, ' Tarikan Tunai ATM ', '4', '2014'),
(6, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-04', 353000, 0, ' Setoran ke Bank (Hasil Celengan) ', '4', '2014'),
(7, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-04', 4075000, 0, ' Setoran ke Bank (Hasil Celengan Jumat) ', '4', '2014'),
(8, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-04', 462000, 0, ' Setoran ke Bank (Hasil Celengan Renovasi) ', '4', '2014'),
(9, '1102', 'BANK', '', '2014-04-04', 775000, 0, ' Setoran ke Bank (Hasil SPP) ', '4', '2014'),
(10, '1102', 'BANK', '', '2014-04-04', 1200000, 0, ' Setoran ke Bank (Hasil Donatur) ', '4', '2014'),
(11, '1102', 'BANK', '', '2014-04-07', 1883000, 0, ' Setoran ke Bank Hasil Parkir ', '4', '2014'),
(12, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-11', 1012000, 0, ' Setoran ke Bank Hasil Celengan ', '4', '2014'),
(13, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-11', 178000, 0, ' Setoran ke Bank Hasil Celengan Renovasi ', '4', '2014'),
(14, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-11', 4131000, 0, ' Setoran ke Bank Hasil Celengan Jumat ', '4', '2014'),
(15, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-11', 406000, 0, ' Setoran ke Bank Hasil Celengan Renovasi ', '4', '2014'),
(16, '1102', 'BANK', '', '2014-04-11', 1900000, 0, ' Setoran ke Bank Hasil Donatur ', '4', '2014'),
(17, '1102', 'BANK', '', '2014-04-14', 275000, 0, ' Setoran ke Bank SPP ', '4', '2014'),
(18, '1102', 'BANK', '', '2014-04-14', 300000, 0, ' Setoran ke Bank Infaq Penggunaan Masjid ', '4', '2014'),
(19, '4300', 'SUMBANGAN DARI DONATUR TIDAK TETAP', '', '2014-04-15', 200000, 0, ' Sumbangan dari Helmy ', '4', '2014'),
(20, '5110', '', 'BIAYA ADMINISTRASI BANK', '2014-04-18', 0, 13000, ' Biaya Administrasi Bank ', '4', '2014'),
(21, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-22', 490000, 0, ' Setoran Ke Bank Hasil Celengan ', '4', '2014'),
(22, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-22', 260000, 0, ' Setoran ke Bank Hasil Celengan Renovasi ', '4', '2014'),
(23, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-22', 3855000, 0, ' Setoran Ke Bank Hasil Celengan Jumat ', '4', '2014'),
(24, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-22', 289000, 0, ' Setoran ke Bank Hasil Celengan Renovasi ', '4', '2014'),
(25, '1102', 'BANK', '', '2014-04-22', 800000, 0, ' Setoran ke Bank Hasil Donatur ', '4', '2014'),
(26, '1102', 'BANK', '', '2014-04-23', 1200000, 0, ' Setoran ke Bank Hasil Donatur ', '4', '2014'),
(27, '1102', 'BANK', '', '2014-04-23', 937000, 0, ' Setoran ke Bank Hasil SPP ', '4', '2014'),
(28, '4300', 'SUMBANGAN DARI DONATUR TIDAK TETAP', '', '2014-04-23', 15000000, 0, ' Setoran ke Bank Pengembangan Masjid ', '4', '2014'),
(29, '1102', '', 'BANK', '2014-04-24', 0, 5000000, ' Tarikan Tunai ATM ', '4', '2014'),
(30, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-25', 1009000, 0, ' Setoran ke Bank Hasil Celengan ', '4', '2014'),
(31, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-25', 88000, 0, ' Setoran ke Bank Hasil Celengan Renovasi ', '4', '2014'),
(32, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-25', 3983000, 0, ' Setoran ke Bank Hasil Celengan Jumat ', '4', '2014'),
(33, '1102', '', 'BANK', '2014-04-28', 0, 10000000, ' Tarikan Tunai ATM ', '4', '2014'),
(34, '1102', '', 'BANK', '2014-04-29', 0, 10000000, ' Tarikan Tunai ATM ', '4', '2014'),
(35, '4200', 'INFAQ DARI DONATUR TETAP', '', '2014-04-30', 1500000, 0, ' Transfer dari Husin Fuad Februari ', '4', '2014'),
(36, '4200', 'INFAQ DARI DONATUR TETAP', '', '2014-04-30', 1500000, 0, ' Transfer dari Husin Fuad April ', '4', '2014'),
(37, '4500', 'PENDAPATAN LAIN-LAIN', '', '2014-04-30', 13571, 0, ' Bunga Bank ', '4', '2014'),
(38, '5111', '', 'BIAYA LAIN-LAIN', '2014-04-30', 0, 665000, ' Koreksi Bunga Bank ', '4', '2014'),
(39, '5111', '', 'BIAYA LAIN-LAIN', '2014-04-30', 0, 2581, ' Pajak Bunga Bank ', '4', '2014');
...
INSERT INTO `data_transaksi_donatur` (`ID_TRANSAKSI`, `TANGGAL_TRANSAKSI`, `NAMA_DONATUR`, `JUMLAH_DONASI_L`, `JUMLAH_DONASI_TL`, `KODE_DONATUR`, `KETERANGAN`, `BULAN_LAPORAN`, `TAHUN_LAPORAN`) VALUES
(1, '2014-10-02', 'Muhammad', 200000, 0, '1', 'asdas', '', ''),
(2, '2014-11-02', 'Isa', 20000000, 0, '2', 'Donatur Tetap', '', '');
...
CREATE TABLE IF NOT EXISTS `data_transaksi_kas` (
  ...
  `NAMA_PENGELUARAN` varchar(50) NOT NULL,
  `TANGGAL_LAPORAN` date NOT NULL,
  `MASUK_KAS` bigint(20) NOT NULL,
  `KELUAR_KAS` bigint(20) NOT NULL,
  `KETERANGAN` varchar(200) NOT NULL,
  `BULAN_LAPORAN` varchar(10) NOT NULL,
  `TAHUN_LAPORAN` varchar(20) NOT NULL,
...
(40, '4500', 'PENDAPATAN LAIN-LAIN', '', '2014-04-05', 20000, 0, ' Hasil Infaq dari Kaset ', '4', '2014'),
(39, '4500', 'PENDAPATAN LAIN-LAIN', '', '2014-04-05', 1883000, 0, ' Hasil Infaq dari Parkir ', '4', '2014'),
(38, '5101', '', 'GAJI KARYAWAN', '2014-04-05', 0, 2000000, ' Gaji CS dan Pengawas Kebersihan ', '4', '2014'),
(37, '1101', '', 'KAS', '2014-04-04', 0, 1200000, ' Setoran ke Bank (Hasil Donatur) ', '4', '2014'),
(36, '1101', '', 'KAS', '2014-04-04', 0, 775000, ' Setoran ke Bank (Hasil SPP) ', '4', '2014'),
(35, '1101', '', 'KAS', '2014-04-04', 0, 462000, ' Setoran ke Bank (Hasil Celengan Renovasi) ', '4', '2014'),
(34, '1101', '', 'KAS', '2014-04-04', 0, 4075000, ' Setoran ke Bank (Hasil Celengan Jumat) ', '4', '2014'),
(33, '1101', '', 'KAS', '2014-04-04', 0, 353000, ' Setoran ke Bank (Hasil Celengan) ', '4', '2014'),
(32, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-04', 450000, 0, ' Hasil Infaq dari Celengan Renovasi ', '4', '2014'),
(31, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-04', 4075000, 0, ' Hasil Infaq dari Celengan Jumat  ', '4', '2014'),
(30, '5106', '', 'DAKWAH', '2014-04-04', 0, 200000, ' Transport Kajian Jumat Ba''da Maghrib  ', '4', '2014'),
(29, '5102', '', 'INSENTIF', '2014-04-04', 0, 75000, ' Insentif Rekaman Kajian Bulanan ', '4', '2014'),
(28, '5102', '', 'INSENTIF', '2014-04-04', 0, 150000, ' Insentif Pengganti Muadzin Ahad ', '4', '2014'),
(27, '5108', '', 'KONSUMSI', '2014-04-04', 0, 22000, ' Beli Aqua Gelas ', '4', '2014'),
(26, '5106', '', 'DAKWAH', '2014-04-04', 0, 450000, ' Transport untuk Khotib Jumat ', '4', '2014'),
(25, '5108', '', 'KONSUMSI', '2014-04-04', 0, 14500, ' Beli Nasi untuk Khotib Jumat ', '4', '2014'),
(24, '5103', '', 'KEPERLUAN KANTOR', '2014-04-04', 0, 30000, ' Beli Sabun ', '4', '2014'),
(23, '5103', '', 'KEPERLUAN KANTOR', '2014-04-04', 0, 59000, ' Beli Gula, Kopi, dan Jahe ', '4', '2014'),
(22, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-03', 12000, 0, ' Hasil Infaq dari Celengan Renovasi Tgl 3 ', '4', '2014'),
(85, '5108', '', 'KONSUMSI', '2014-04-21', 0, 136000, ' Konsumsi Ust. Ad-Duwaisy+Ust. Wafi ', '4', '2014'),
(84, '5108', '', 'KONSUMSI', '2014-04-19', 0, 96000, ' Konsumsi Kajian ', '4', '2014'),
(83, '5108', '', 'KONSUMSI', '2014-04-19', 0, 175000, ' Beli Aqua Gelas 10 Dos ', '4', '2014'),
(82, '5103', '', 'KEPERLUAN KANTOR', '2014-04-19', 0, 120000, ' Beli Lampu TL ', '4', '2014'),
(81, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-18', 289000, 0, ' Hasil Infaq dari Celengan Renovasi Tgl 18  ', '4', '2014'),
(80, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-18', 3855000, 0, ' Hasil Infaq dari Celengan Jumat Tgl 18  ', '4', '2014'),
(79, '5103', '', 'KEPERLUAN KANTOR', '2014-04-18', 0, 30000, ' Buat Papan Petunjuk untuk Wanita ', '4', '2014'),
(78, '5106', '', 'DAKWAH', '2014-04-18', 0, 400000, ' Transport Khotib Jumat ', '4', '2014'),
(77, '5108', '', 'KONSUMSI', '2014-04-18', 0, 14500, ' Beli Nasi untuk Khotib Jumat ', '4', '2014'),
(76, '5109', '', 'LISTRIK DAN TELEPON', '2014-04-18', 0, 54000, ' Beli Pulsa SMS Center ', '4', '2014'),
(75, '5103', '', 'KEPERLUAN KANTOR', '2014-04-18', 0, 22500, ' Beli Sabun ', '4', '2014'),
(74, '4200', 'INFAQ DARI DONATUR TETAP', '', '2014-04-17', 800000, 0, ' Hasil Infaq dari Donatur ', '4', '2014'),
(73, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-17', 260000, 0, ' Hasil Infaq dari Celengan Renovaso Tgl 17 ', '4', '2014'),
(72, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-17', 490000, 0, ' Hasil Infaq dari Celengan Tgl 17 ', '4', '2014'),
(71, '5103', '', 'KEPERLUAN KANTOR', '2014-04-17', 0, 200, ' Cetak Buletin ', '4', '2014'),
(70, '5111', '', 'BIAYA LAIN-LAIN', '2014-04-17', 0, 850000, ' Pembayaran Tastis Lewat Bpk Abdurrahman ', '4', '2014'),
(69, '5107', '', 'AKOMODASI', '2014-04-16', 0, 1844100, ' Tiket Pesawat Ust. A. Satori ', '4', '2014'),
(68, '5103', '', 'KEPERLUAN KANTOR', '2014-04-16', 0, 32000, ' Beli Aqua Gelas ', '4', '2014'),
(21, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-03', 353000, 0, ' Hasil Infaq dari Celengan Tgl 3 ', '4', '2014'),
(20, '4400', 'INFAQ UNTUK PROGRAM', '', '2014-04-03', 775000, 0, ' SPP Peserta Tahfid & Tahsin ', '4', '2014'),
(19, '4200', 'INFAQ DARI DONATUR TETAP', '', '2014-04-03', 1200000, 0, ' Hasil Infaq dari Donatur ', '4', '2014'),
(18, '5106', '', 'DAKWAH', '2014-04-02', 0, 400000, ' Transport Kajian Selasa Ba''da Maghrib ', '4', '2014'),
(17, '5102', '', 'INSENTIF', '2014-04-02', 0, 80000, ' Insentif Publikasi ', '4', '2014'),
(16, '5102', '', 'INSENTIF', '2014-04-02', 0, 160000, ' Insentif Pemasangan Spanduk ', '4', '2014'),
(15, '5102', '', 'INSENTIF', '2014-04-02', 0, 40000, ' Insentif Penyebaran Brosur ', '4', '2014'),
(14, '5102', '', 'INSENTIF', '2014-04-02', 0, 54000, ' Insentif Penjaga Kajian Bulanan ', '4', '2014'),
(13, '5104', '', 'TRANSPORTASI', '2014-04-02', 0, 60000, ' Transport Jalan Pengambilan Donatur ', '4', '2014'),
(12, '5103', '', 'KEPERLUAN KANTOR', '2014-04-02', 0, 120000, ' Print Poster Kajian Bulanan ', '4', '2014'),
(11, '5103', '', 'KEPERLUAN KANTOR', '2014-04-02', 0, 40000, ' Beli Buku Iqro ', '4', '2014'),
(10, '5103', '', 'KEPERLUAN KANTOR', '2014-04-02', 0, 25000, ' Print Warna A3 ', '4', '2014'),
(9, '5103', '', 'KEPERLUAN KANTOR', '2014-04-02', 0, 1312500, ' Cetak Spanduk Kajian Bulanan ', '4', '2014'),
(8, '5103', '', 'KEPERLUAN KANTOR', '2014-04-02', 0, 135000, ' Setting ', '4', '2014'),
(7, '5106', '', 'DAKWAH', '2014-04-02', 0, 7800000, ' Transport Guru Tahfid & Tahsin  ', '4', '2014'),
(6, '1101', 'KAS', '', '2014-04-02', 7000000, 0, ' Tarikan Tunai ATM ', '4', '2014'),
(5, '1101', '', 'KAS', '2014-04-02', 0, 1011000, ' Setoran ke Bank (Infaq Celengan Renovasi) ', '4', '2014'),
(4, '1101', '', 'KAS', '2014-04-02', 0, 400000, ' Setoran ke Bank (SPP) ', '4', '2014'),
(3, '1101', '', 'KAS', '2014-04-02', 0, 272000, ' Setoran ke Bank (Infaq Celengan Renovasi) ', '4', '2014'),
(1, '1101', 'KAS', '', '2014-04-01', 21597500, 0, ' Saldo Awal ', '4', '2014'),
(2, '4400', 'INFAQ UNTUK PROGRAM', '', '2014-04-01', 400000, 0, ' SPP Peserta Tahfid & Tahsin ', '4', '2014'),
(67, '4400', 'INFAQ UNTUK PROGRAM', '', '2014-04-16', 250000, 0, ' SPP Peserta Tahsin dan Tahfid ', '4', '2014'),
(66, '4500', 'PENDAPATAN LAIN-LAIN', '', '2014-04-14', 40000, 0, ' Kembalian Tiket Pesawat ', '4', '2014'),
(65, '4400', 'INFAQ UNTUK PROGRAM', '', '2014-04-14', 327000, 0, ' SPP Peserta Tahsin dan Tahfid ', '4', '2014'),
(64, '5103', '', 'KEPERLUAN KANTOR', '2014-04-14', 0, 59000, ' Beli Gula, Kopi, dan Jahe ', '4', '2014'),
(63, '5102', '', 'INSENTIF', '2014-04-14', 0, 50000, ' Insentif Lemburan Ahad ', '4', '2014'),
(62, '1101', '', 'KAS', '2014-04-14', 0, 300000, ' Setoran ke Bank Infaq Penggunaan Masjid ', '4', '2014'),
(61, '1101', '', 'KAS', '2014-04-14', 0, 275000, ' Setoran ke Bank SPP ', '4', '2014'),
(60, '1101', '', 'KAS', '2014-04-11', 0, 1900000, ' Setoran ke Bank Hasil Donatur ', '4', '2014'),
(59, '1101', '', 'KAS', '2014-04-11', 0, 406000, ' Setoran ke Bank Hasil Celengan Renovasi ', '4', '2014'),
(58, '1101', '', 'KAS', '2014-04-11', 0, 4131000, ' Setoran ke Bank Hasil Celengan Jumat ', '4', '2014'),
(57, '1101', '', 'KAS', '2014-04-11', 0, 178000, ' Setoran ke Bank Hasil Celengan Renovasi ', '4', '2014'),
(56, '1101', '', 'KAS', '2014-04-11', 0, 1012000, ' Setoran ke Bank Hasil Celengan ', '4', '2014'),
(55, '4500', 'PENDAPATAN LAIN-LAIN', '', '2014-04-11', 300000, 0, ' Infaq Penggunaan Masjid untuk Nikah ', '4', '2014'),
(54, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-11', 406000, 0, ' Hasil Infaq dari Celengan Renovasi Tgl 11 ', '4', '2014'),
(53, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-11', 4131000, 0, ' Hasil Infaq dari Celengan Jumat Tgl 11 ', '4', '2014'),
(52, '5106', '', 'DAKWAH', '2014-04-11', 0, 400000, ' Transport Khotib Jumat ', '4', '2014'),
(51, '5108', '', 'KONSUMSI', '2014-04-11', 0, 14500, ' Beli Nasi untuk Khotib Jumat ', '4', '2014'),
(50, '5103', '', 'KEPERLUAN KANTOR', '2014-04-11', 0, 120000, ' Beli Parfum Karpet + Methanol ', '4', '2014'),
(49, '5103', '', 'KEPERLUAN KANTOR', '2014-04-11', 0, 12500, ' Beli Gula ', '4', '2014'),
(48, '5103', '', 'KEPERLUAN KANTOR', '2014-04-11', 0, 12000, ' Beli Sabun ', '4', '2014'),
(47, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-10', 178000, 0, ' Hasil Infaq dari Celengan Renovasi Tgl 10 ', '4', '2014'),
(46, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-10', 1012000, 0, ' Hasil Infaq dari Celengan Tgl 10 ', '4', '2014'),
(45, '4200', 'INFAQ DARI DONATUR TETAP', '', '2014-04-10', 1900000, 0, ' Hasil Infaq dari Donatur ', '4', '2014'),
(44, '5106', '', 'DAKWAH', '2014-04-08', 0, 100000, ' Transport Guru Tahfid & Tahsin  Tgl 7 ', '4', '2014'),
(43, '1101', '', 'KAS', '2014-04-07', 0, 1883000, ' Setoran ke Bank Hasil Parkir ', '4', '2014'),
(41, '4400', 'INFAQ UNTUK PROGRAM', '', '2014-04-05', 275000, 0, ' SPP Peserta Tahsin dan Tahfid ', '4', '2014'),
(42, '5106', '', 'DAKWAH', '2014-04-05', 0, 100000, ' Transport Guru Tahfid & Tahsin  Tgl 4 ', '4', '2014'),
(86, '1101', '', 'KAS', '2014-04-22', 0, 490000, ' Setoran Ke Bank Hasil Celengan ', '4', '2014'),
(87, '1101', '', 'KAS', '2014-04-22', 0, 260000, ' Setoran ke Bank Hasil Celengan Renovasi ', '4', '2014'),
(88, '1101', '', 'KAS', '2014-04-22', 0, 3855000, ' Setoran Ke Bank Hasil Celengan Jumat ', '4', '2014'),
(89, '1101', '', 'KAS', '2014-04-22', 0, 289000, ' Setoran ke Bank Hasil Celengan Renovasi ', '4', '2014'),
(90, '1101', '', 'KAS', '2014-04-22', 0, 800000, ' Setoran ke Bank Hasil Donatur ', '4', '2014'),
(91, '5103', '', 'KEPERLUAN KANTOR', '2014-04-22', 0, 13000, ' Beli Kwitansi dan Materai ', '4', '2014'),
(92, '5103', '', 'KEPERLUAN KANTOR', '2014-04-22', 0, 85000, ' Pasang Stiker Pintu ', '4', '2014'),
(93, '5102', '', 'INSENTIF', '2014-04-22', 0, 54000, ' Insentif Penjaga Kajian Bulanan ', '4', '2014'),
(94, '4400', 'INFAQ UNTUK PROGRAM', '', '2014-04-22', 360000, 0, ' SPP Peserta Tahsin dan Tahfid ', '4', '2014'),
(95, '4200', 'INFAQ DARI DONATUR TETAP', '', '2014-04-22', 1200000, 0, ' Hasil Infaq dari Donatur ', '4', '2014'),
(96, '4300', 'SUMBANGAN DARI DONATUR TIDAK TETAP', '', '2014-04-23', 15000000, 0, ' Sumbangan untuk Pengembangan Masjid ', '4', '2014'),
(97, '1101', '', 'KAS', '2014-04-23', 0, 1200000, ' Setoran ke Bank Hasil Donatur ', '4', '2014'),
(98, '1101', '', 'KAS', '2014-04-23', 0, 937000, ' Setoran ke Bank Hasil SPP ', '4', '2014'),
(99, '1101', '', 'KAS', '2014-04-23', 0, 15000000, ' Setoran ke Bank Pengembangan Masjid ', '4', '2014'),
(100, '1101', 'KAS', '', '2014-04-24', 5000000, 0, ' Tarikan Tunai ATM ', '4', '2014'),
(101, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-24', 1009000, 0, ' Hasil Infaq dari Celengan Tgl 24 ', '4', '2014'),
(102, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-24', 88000, 0, ' Hasil Infaq dari Celengan Renovasi Tgl 24 ', '4', '2014'),
(103, '5103', '', 'KEPERLUAN KANTOR', '2014-04-25', 0, 21000, ' Beli Sabun ', '4', '2014'),
(104, '5108', '', 'KONSUMSI', '2014-04-25', 0, 175000, ' Beli Aqua Gelas 10 Dos ', '4', '2014'),
(105, '5108', '', 'KONSUMSI', '2014-04-25', 0, 94000, ' Konsumsi Kajian Bulanan ', '4', '2014'),
(106, '5102', '', 'INSENTIF', '2014-04-25', 0, 100000, ' Insentif Penjaga Sandal ', '4', '2014'),
(107, '5102', '', 'INSENTIF', '2014-04-25', 0, 100000, ' Insentif Pengatur Shaf ', '4', '2014'),
(108, '5106', '', 'DAKWAH', '2014-04-25', 0, 400000, ' Transport Khotib Jumat ', '4', '2014'),
(109, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-25', 3983000, 0, ' Hasil Infaq dari Celengan Jumat Tgl 25 ', '4', '2014'),
(110, '1101', '', 'KAS', '2014-04-25', 0, 1009000, ' Setoran ke Bank Hasil Celengan ', '4', '2014'),
(111, '1101', '', 'KAS', '2014-04-25', 0, 88000, ' Setoran ke Bank Hasil Celengan Renovasi ', '4', '2014'),
(112, '1101', '', 'KAS', '2014-04-25', 0, 3983000, ' Setoran ke Bank Hasil Celengan Jumat ', '4', '2014'),
(113, '5102', '', 'INSENTIF', '2014-04-26', 0, 54000, ' Insentif Penjaga Kajian Bulanan ', '4', '2014'),
(114, '5102', '', 'INSENTIF', '2014-04-26', 0, 40000, ' Insentif Pemasangan Spanduk ', '4', '2014'),
(115, '5103', '', 'KEPERLUAN KANTOR', '2014-04-26', 0, 59000, ' Beli Gula, Kopi, dan Jahe ', '4', '2014'),
(116, '1101', 'KAS', '', '2014-04-28', 10000000, 0, ' Tarikan Tunai ATM ', '4', '2014'),
(117, '1101', 'KAS', '', '2014-04-29', 10000000, 0, ' Tarikan Tunai ATM ', '4', '2014'),
(118, '4500', 'PENDAPATAN LAIN-LAIN', '', '2014-04-29', 312000, 0, ' Pengembalian Tiket ', '4', '2014'),
(119, '4500', 'PENDAPATAN LAIN-LAIN', '', '2014-04-29', 4000000, 0, ' Infaq dari Trawas ', '4', '2014'),
(120, '4500', 'PENDAPATAN LAIN-LAIN', '', '2014-04-29', 2426000, 0, ' Pinjaman Ust. Ahmad ', '4', '2014'),
(121, '5106', '', 'DAKWAH', '2014-04-29', 0, 6000000, ' Muballigh ', '4', '2014'),
(122, '5107', '', 'AKOMODASI', '2014-04-29', 0, 740000, ' Transportasi dan Konsumsi ', '4', '2014'),
(123, '5107', '', 'AKOMODASI', '2014-04-29', 0, 520000, ' Bayar Hotel ', '4', '2014'),
(124, '5106', '', 'DAKWAH', '2014-04-29', 0, 6100000, ' Transport Guru Tahsin Bulan Februari ', '4', '2014'),
(125, '5103', '', 'KEPERLUAN KANTOR', '2014-04-29', 0, 1132000, ' Cetak Banner dan Karcis Parkir ', '4', '2014'),
(126, '5109', '', 'LISTRIK DAN TELEPON', '2014-04-29', 0, 194000, ' Bayar Tagihan TELKOM ', '4', '2014'),
(127, '4100', 'INFAQ DARI CELENGAN', '', '2014-04-30', 1146000, 0, ' Hasil Infaq dari Celengan Tgl 30 ', '4', '2014'),
(128, '5106', '', 'DAKWAH', '2014-04-30', 0, 5500000, ' Transport Pengajar Tahsin ', '4', '2014'),
(129, '5101', '', 'GAJI KARYAWAN', '2014-04-30', 0, 2000000, ' Gaji CS dan Pengawas Kebersihan ', '4', '2014'),
(130, '5101', '', 'GAJI KARYAWAN', '2014-04-30', 0, 13200000, ' Gaji Karyawan Takmir ', '4', '2014'),
(131, '5102', '', 'INSENTIF', '2014-04-30', 0, 500000, ' Insentif Penjaga Sound System ', '4', '2014'),
(132, '5106', '', 'DAKWAH', '2014-04-30', 0, 800000, ' Transport Kajian Ba''da Maghrib Senin ', '4', '2014'),
(133, '5106', '', 'DAKWAH', '2014-04-30', 0, 1000000, ' Transport Kajian Ba''da Maghrib Selasa ', '4', '2014'),
(134, '5106', '', 'DAKWAH', '2014-04-30', 0, 750000, ' Transport Kajian Ba''da Maghrib Jumat ', '4', '2014'),
(135, '5102', '', 'INSENTIF', '2014-04-30', 0, 150000, ' Insentif Pengganti Muadzin Ahad ', '4', '2014');
...
('1', 'Muhammad', 9000000000, 'Akhir Bulan');
...
('1102', 'BANK'),
('4200', 'INFAQ DARI DONATUR TETAP'),
('4300', 'SUMBANGAN DARI DONATUR TIDAK TETAP'),
('4400', 'INFAQ UNTUK PROGRAM'),
('4500', 'PENDAPATAN LAIN-LAIN'),
('4100', 'INFAQ DARI CELENGAN'),
('1101', 'KAS');
...
('5107', 'AKOMODASI'),
('5108', 'KONSUMSI'),
('5109', 'Listrik dan Telepon'),
('5110', 'BIAYA ADMINISTRASI BANK'),
('5111', 'BIAYA LAIN-LAIN'),
('1101', 'KAS'),
('1102', 'BANK');
